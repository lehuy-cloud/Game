...
struct StoryChapterView: View {
    ...
    private var hasHeroImage: Bool { currentPage.imageName != nil }
    ...
    var body: some View {
        ZStack {
            ...
            // LỖI ĐÃ SỬA: thiếu lớp phủ tối phía trên nên nút back + tên chương
            // (chữ trắng) dính vào tranh sáng.
            if hasHeroImage { TopScrim(height: isRegularWidth ? 300 : 200) }
            ...
            VStack(spacing: 0) {
                ...
                ReadingProgressBar(current: pageIndex + 1, total: chapter.pages.count, theme: theme,
                                   maxTicks: 8,
                                   thickness: isRegularWidth ? 9 : 7,
    ...
    // LỖI ĐÃ SỬA: header trước đây khoá cứng cỡ iPhone (nút 44, tên chương 17pt)
    // nên trên iPad nó bé xíu so với thiết kế (nút 56, tên chương 30pt).
    ...
    /// P5: tranh chiếm phần trên, chữ nổi dần lên từ vùng gradient mờ ở đáy ảnh.
